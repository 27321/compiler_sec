...
# kernel path: /workspace/Documents/pytorch2_wjk/fusion_injection/inductor_cache/x3/cx3zau3zk5xplkym7byskygkiddoshxwwthqactsg3wh2al6ejfs.py
...
# kernel path: /workspace/Documents/pytorch2_wjk/fusion_injection/inductor_cache/oc/cocck46kdugdmhaj5s63zuo6b4knh2y655bp5fmurtszdh4bducr.py
...
# kernel path: /workspace/Documents/pytorch2_wjk/fusion_injection/inductor_cache/gf/cgf3ps2cuumg5jfcbjywwt7szrp4cgbuop7k5zr4x3aawetq3rde.py
...
@triton_heuristics.pointwise(
    size_hints={'x': 256}, 
    filename=__file__,
    triton_meta={'signature': {'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'native_matmul': False, 'configs': [{(0,): [['tt.divisibility', 16]]}], 'enable_fp_fusion': True},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'atomic_add_found': False, 'num_load': 0, 'num_store': 0, 'num_reduction': 0, 'backend_hash': '6D03EF8623B43E91D2B07D99F37EF45253583FC82EA89D5F63B13004C4A2B217', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'are_deterministic_algorithms_enabled': False, 'tiling_scores': {'x': 0}},
    min_elem_per_thread=0
)
@triton.jit
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_2.run(256, stream=stream0)
